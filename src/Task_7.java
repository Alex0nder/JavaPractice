...
//Так же, необходимо учесть что может быть введено отрицательное значение. В таком случае сообзить о некорректности ввода.
...
public class Task_7 {
    public static void main(String[] args) {
        ...
        if (floorCount >= 1 && floorCount <= 4) {
            System.out.println("Малоэтажный док");
